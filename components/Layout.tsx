  ...
  <button
    ...
    className={`
      ...
      ${isActive 
        ...
        : 'bg-transparent text-[#FCEE0A] border-[#FCEE0A] hover:bg-[#FCEE0A] hover:text-black'}
    `}
  >
...
export const Layout: React.FC<LayoutProps> = ({ children, currentView, onNavigate }) => {
  return (
    <div className="min-h-screen bg-[#050505] text-gray-300 p-2 md:p-6 font-mono relative overflow-hidden flex flex-col">
      ...
      {/* Header */}
      <header className="relative z-10 border-b-2 border-[#FCEE0A] pb-4 mb-6 flex flex-col md:flex-row justify-between items-end gap-4">
        <div>
          <h1 className="text-4xl md:text-6xl font-black italic tracking-tighter text-[#FCEE0A] uppercase" style={{ textShadow: '2px 2px 0px #FF003C' }}>
            CITY ARCHIVE
          </h1>
          <p className="text-[#00F0FF] font-mono-tech text-sm tracking-[0.2em] mt-1">
            PROTOCOL: 2077 // SECURE CONNECTION
          </p>
        </div>
        <div className="flex gap-4 items-center font-mono-tech text-xs text-[#FF003C]">
      ...
      {/* Footer */}
      <footer className="relative z-10 mt-12 border-t border-gray-800 pt-4 text-center font-mono-tech text-xs text-gray-600">
